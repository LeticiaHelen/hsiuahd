...
<head>
  ...
  <style type="text/css">
    ...
    .fundoIndex{
        position: relative;
        background-image: linear-gradient(to bottom right,#25506b,#f7ac22);
        opacity: .9; 
    }
...
<div class="ui large top fixed menu transition hidden">
  <div class="ui container">
    ...
    <div class="right menu">
      ...
      <div class="item">
        <a class="ui primary button" href="login.php">Sign Up</a>
      </div>
    </div>
  </div>
</div>
...
<!-- Page Contents -->
<div class="pusher">
  <div class="ui inverted vertical masthead center aligned segment fundoIndex">
